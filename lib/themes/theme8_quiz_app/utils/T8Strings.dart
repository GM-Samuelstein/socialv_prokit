...
const t8_lbl_what_would_you_like_to_learn_n_today_search_below =
...
const t8_lbl_biology_amp_scientific_method =
    "Biology &amp; The \n Scientific Method";
const t8_text_4_to_8_lesson = "4 to 8 lesson";
const t8_lbl_begin = "Begin";

const t8_lbl_setting = "Settings";
const t8_lbl_profile = "Profile";
const t8_username = "Antonio Perez";
const t8_lbl_edit_profile = "Edit Profile";
const t8_email = "antonio@gmail.com";
const t8_lbl_faq = "FAQ";
const t8_sub_info_faq = "updated 2 week ago";
const t8_lbl_about_app = "About App";
const t8_lbl_rate_app = "Rate App";
const t8_lbl_share_app = "Share App";
const t8_lbl_dark_mode = "Dark Mode";
const t8_lbl_privacy = "Privacy & Terms";
const t8_lbl_help_center = "Help Center";
